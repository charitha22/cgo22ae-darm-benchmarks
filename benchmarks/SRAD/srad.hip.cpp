...
void runTest(int argc, char **argv) {
  ...
  for (iter = 0; iter < niter; iter++) {
    ...
    hipLaunchKernelGGL(srad_cuda_1, dim3(dimGrid), dim3(dimBlock), 0, 0, E_C,
                       W_C, N_C, S_C, J_cuda, C_cuda, cols, rows, q0sqr);
    hipLaunchKernelGGL(srad_cuda_2, dim3(dimGrid), dim3(dimBlock), 0, 0, E_C,
                       W_C, N_C, S_C, J_cuda, C_cuda, cols, rows, lambda,
                       q0sqr);
